...
// IEtherman is an autogenerated mock type for the IEtherman type
type IEtherman struct {
	mock.Mock
}

// FilterSequenceBatches provides a mock function with given fields: opts, numBatch
func (_m *IEtherman) FilterSequenceBatches(opts *bind.FilterOpts, numBatch []uint64) (*cdkvalidium.CdkvalidiumSequenceBatchesIterator, error) {
...
func (_m *IEtherman) GetCurrentDataCommittee() (*etherman.DataCommittee, error) {
	ret := _m.Called()
...
func (_m *IEtherman) GetCurrentDataCommitteeMembers() ([]etherman.DataCommitteeMember, error) {
	ret := _m.Called()
...
func (_m *IEtherman) GetTx(ctx context.Context, txHash common.Hash) (*types.Transaction, bool, error) {
...
func (_m *IEtherman) HeaderByNumber(ctx context.Context, number *big.Int) (*types.Header, error) {
...
func (_m *IEtherman) TrustedSequencer() (common.Address, error) {
	ret := _m.Called()
...
func (_m *IEtherman) TrustedSequencerURL() (string, error) {
	ret := _m.Called()
...
func (_m *IEtherman) WatchSetTrustedSequencer(opts *bind.WatchOpts, sink chan<- *cdkvalidium.CdkvalidiumSetTrustedSequencer) (event.Subscription, error) {
...
func (_m *IEtherman) WatchSetTrustedSequencerURL(opts *bind.WatchOpts, sink chan<- *cdkvalidium.CdkvalidiumSetTrustedSequencerURL) (event.Subscription, error) {
	ret := _m.Called(opts, sink)
...
// NewIEtherman creates a new instance of IEtherman. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewIEtherman(t interface {
	mock.TestingT
	Cleanup(func())
}) *IEtherman {
	mock := &IEtherman{}
