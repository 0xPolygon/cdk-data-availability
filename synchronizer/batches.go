...
type BatchSynchronizer struct {
	...
	events           chan *validium.PolygonvalidiumetrogSequenceBatches
...
func NewBatchSynchronizer(
	...
	synchronizer := &BatchSynchronizer{
		...
		db:               db,
		reorgs:           reorgs,
		events:           make(chan *validium.PolygonvalidiumetrogSequenceBatches),
		sequencer:        sequencer,
...
func (bs *BatchSynchronizer) handleEvent(event *validium.PolygonvalidiumetrogSequenceBatches) error {
