...
func TestSignSequence(t *testing.T) {
	...
	expectedSequence := types.Sequence{
		Batches: []types.Batch{
			{
				Number:               3,
				ForcedGlobalExitRoot: common.HexToHash("0x678343456734678"),
				ForcedTimestamp:      3457834,
			...
			{
				Number:               4,
				ForcedGlobalExitRoot: common.HexToHash("0x34678345678345789534678912345678"),
				ForcedTimestamp:      78907890,
